...
import { setForgetPass } from "../../api/userApi";
...
const ForgetPassword: React.FC = () => {
  ...
  const passwordMutation= useMutation({
    ...
    mutationFn: (email:string)=>setForgetPass(email),
    onError:()=>{
      Modal.success({
        title: "Forget Password Request",
        content:
          "If an account is associated with the provided email address, a password reset link will be sent to your email address.",
    ...
    const OnFinish: FormProps["onFinish"] = (values:{email:string}) => {
      passwordMutation.mutate(values.email);
